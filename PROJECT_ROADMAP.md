...
**MCP tools provided:** `token_squeezer_read_symbols`
...
**MCP tools provided:** `repograph_index`, `repograph_query`, `repograph_get_call_hierarchy`, `repograph_get_dependencies`
